...
if __name__ == "__main__":
    ...
    parser.add_argument("yolov8n.pt", help="Path to trained model")
    parser.add_argument("train", help="Path to image or video file")
    ...
    print("Output data path:", args.output)
    ...
    if os.path.isfile(args.output):
        ...
        print(f"Error: {args.output} is not a valid file")
